...
public class frmQuanlyDanhba extends javax.swing.JFrame {
    ...
    private void btnDongyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDongyActionPerformed
        ...
        else if(trangthai.equalsIgnoreCase("Update"))
        {
            Phone p = new Phone(hoten, dienthoai, email);
            int i = this.tblDanhBa.getSelectedRow();
            if(this.phoneBooks.updateItem(i, p))
            {
                ShowPhoneBooksToTable();
            }
        }
    ...
    private void btnLoadDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadDataActionPerformed
        ...
        JFileChooser fc = new JFileChooser();
        FileNameExtensionFilter fft = 
        new FileNameExtensionFilter("Dữ liệu (Data, Text)", new String[]{"dat","txt"} );
        fc.addChoosableFileFilter(fft);
        FileNameExtensionFilter fft2 =
        new FileNameExtensionFilter("Dữ liệu (Data)", new String[]{"dat"} );
        fc.addChoosableFileFilter(fft2);
        int res =  fc.showOpenDialog(this);
        if(res == JFileChooser.APPROVE_OPTION)
        {
            File file = fc.getSelectedFile();
    ...
    private void tblDanhBaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDanhBaMouseClicked
        ...
        String email = (String)dtm.getValueAt(i, 3);
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        {
            int rep=JOptionPane.showConfirmDialog(this, "Xác thực xóa", "Bạn chắc chắn xóa?" , JOptionPane.YES_NO_OPTION );
            if(rep == JOptionPane.YES_OPTION)
            {
                this.phoneBooks.deleteItem(i);
                ShowPhoneBooksToTable();
