 ...
 * @author admin
 */
public class sdsd extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sdsd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
